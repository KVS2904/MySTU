...
bool USTUWeaponComponent::GetWeaponAmmoData(FAmmoData& CurrentAmmo, FAmmoData& DefaultAmmo) const
{
	if (CurrentWeapon)
	{
...
TArray<ASTUBaseWeapon*> USTUWeaponComponent::GetWeapons() const
{
	return Weapons;
}